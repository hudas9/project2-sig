...
<head>
    ...
    <link rel="icon" type="image/svg+xml" href="{{ asset('img/sulsel.svg') }}">
...
<body style="font-family: Poppins;">
    ...
    <script type="text/javascript">
        ...
        const tiles = L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
            maxZoom: 19,
            attribution: '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a> | <a href="https://sulsel.bps.go.id/id/statistics-table/2/ODMjMg==/jumlah-penduduk-menurut-kabupaten-kota">BPS Sulawesi Selatan</a>'
        }).addTo(map);
        ...
        info.update = function (props) {
            const contents = props ? `<b>${props.name}</b><br />${props.unemploymentRate}%` : 'Hover over a regency';
            this._div.innerHTML = `<h4>Persentase Pengangguran di Kab/Kota Sulsel</h4>${contents}`;
        };
        ...
        function style(feature) {
            return {
                ...
                dashArray: '3',
                fillOpacity: 0.7,
                fillColor: getColor(feature.properties.unemploymentRate)
            };
        }
        ...
        const regencyData = regencies.map(regency => ({
            ...
            properties: {
                name: regency.name,
                id: regency.id,
                unemploymentRate: regency.unemployment_rate,
            },
            geometry: {
                type: regency.type,
        ...
        legend.onAdd = function (map) {
            ...
            const grades = [0, 2, 2.5, 3, 3.5, 4, 5, 7];
            const labels = [];
            let from, to;
